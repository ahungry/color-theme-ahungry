...
(let ((mainbg (if (display-graphic-p)
  ...
  (custom-theme-set-faces
   ...
   '(flycheck-error-list-info ((t (:foreground "#0f0"))))
   '(flycheck-fringe-info ((t (:foreground "#0f0"))))
   '(flycheck-info ((t (:foreground "#0f0"))))
   '(flymake-note ((t (:foreground "#0f0"))))
   '(my-buffer-face ((t (:foreground "#fff" :background "#06c")))) ; Just a local face
   '(region ((t (:background "#444444"))))
   '(link ((t (:underline t :foreground "#3af"))))
   ...
   '(font-lock-function-name-face ((t (:foreground "#fe0" :bold t))))
   '(comint-highlight-input ((t (:foreground "#f39" :italic nil :bold nil))))
   '(comint-highlight-prompt ((t (:foreground "#33cc33"))))
   '(diff-header ((t (:background "#444444"))))
   '(diff-index ((t (:foreground "#ffff00" :bold t))))
   '(ansi-color-black ((t (:background "#fff" :foreground "#000"))))
   ...
   '(gnus-header-name ((t (:bold t :foreground "#3af"))))
   ...
   '(gnus-summary-normal-read ((t (:foreground "#3af"))))
   ...
   '(web-mode-html-tag-bracket-face ((t (:foreground "#555"))))
   ...
   '(helm-grep-cmd-line ((t (:foreground "#0099aa"))))
   '(helm-grep-finish ((t (:foreground "#0099aa"))))
   ...
   '(jc-conjunction-face ((t (:foreground "#ccff00"))))
   '(jc-verb-face ((t (:foreground "#0099ff"))))
