...
(let ((mainbg (when (display-graphic-p) "#101010")));; "default")))
  (custom-theme-set-faces
   ...
   '(font-lock-variable-name-face ((t (:foreground "#af0" :bold nil))))
   '(font-lock-warning-face ((t (:bold t :foreground "#ff0000"))))
   '(font-lock-function-name-face ((t (:foreground "#ff6" :bold t))))
   ...
   '(web-mode-function-call-face ((t (:foreground "#ff6" :bold t))))
